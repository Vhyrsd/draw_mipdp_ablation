...
try:
    ...
    # rolling mean
    window_size = 3
    plt.plot(df['Step'], df['miloss0.001_mitemp0.1_15/50_2022.12.29-22.31.27_train_diffusion_unet_hybrid_lift_image - test/mean_score'].rolling(window=window_size, min_periods=1).mean(), label='0.001_rollingmean', marker='', linestyle='--', color='b')
    plt.plot(df['Step'], df['miloss0.01_mitemp0.1_15/50_2022.12.29-22.31.27_train_diffusion_unet_hybrid_lift_image - test/mean_score'].rolling(window=window_size, min_periods=1).mean(), label='0.01_rollingmean', marker='', linestyle='-', color='r')
    plt.plot(df['Step'], df['miloss0.1_mitemp0.1_15/50_2022.12.29-22.31.27_train_diffusion_unet_hybrid_lift_image - test/mean_score'].rolling(window=window_size, min_periods=1).mean(), label='0.1_rollingmean', marker='', linestyle='-.', color='g')
